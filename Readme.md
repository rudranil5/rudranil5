...
<a href="https://camerapid.com" target="_blank" rel="noopener" style="display: inline-flex; align-items: center; text-decoration: none; background: #000; height: 50px; padding: 0 18px; border-radius: 8px;">
  <img src="https://upload.wikimedia.org/wikipedia/commons/6/65/HackerRank_logo.png" alt="HackerRank Logo" style="height:32px; margin-right:12px;">
  <span style="font-size: 1.35em; font-weight: 700; color: #2EC866; font-family: 'Montserrat', Arial, sans-serif; letter-spacing: 1px;">Hackerrank</span>
</a>
